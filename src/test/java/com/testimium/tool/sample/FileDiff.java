...
public class FileDiff {
    ...
    public static void main(String[] args) throws IOException {
        ...
        LineIterator file1 = FileUtils.lineIterator(new File("sample/compare/text/file-1.txt"), "utf-8");
        LineIterator file2 = FileUtils.lineIterator(new File("sample/compare/text/file-3.txt"), "utf-8");
        ...
        while (file1.hasNext() || file2.hasNext()) {
            ...
            System.out.println("Modification : "+ comparator.getScript().getModifications());
        }
...
class FileCommandsVisitor implements CommandVisitor<Character> {
    ...
    public void generateHTML() throws IOException {
        ...
        // comparison
        String template = FileUtils.readFileToString(new File("templates/TextDiffTemplate.html"), "utf-8");
        String out1 = template.replace("${left}", left);
        String output = out1.replace("${right}", right);
        // Write file to disk.
        FileUtils.write(new File("sample/compare/text/TextFileCompareDiff.html"), output, "utf-8");

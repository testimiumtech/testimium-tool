...
public class ExtentReportDashboard5 {
    ...
    public static void main(String[] args) throws IOException {
       ...
       //String[] dirList = FileUtility.getAllFiles("./reports/1-ABC-1");
        ...
        // Generate dashboard
        generateDashboard(reportDir, "1-ABC-1");
    }
    ...
    public static void generateDashboard(String reportDir, String fileName) {
        File folder = new File(reportDir + "/" + fileName);
        File[] reportFiles = folder.listFiles((dir, name) -> name.endsWith(".html") && !name.equals(fileName + ".html"));
        ...
        try (FileWriter writer = new FileWriter(reportDir + "/" + fileName + "/"+ fileName + ".html")) {

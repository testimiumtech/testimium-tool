 ...
 */
public class ResetBrowserTimezoneCmd implements ExternalCommand<CommandParam, CommandResponse> {
    private WebDriver driver;
    private static ResetBrowserTimezoneCmd resetBrowserTimezoneCmd = new ResetBrowserTimezoneCmd();

    public ResetBrowserTimezoneCmd() {
        this.driver = DriverManager.getInstance().getWebDriver();
    }


    public static ResetBrowserTimezoneCmd getInstance() {
        //TODO Fix Me for concurrent access and change it to lazy
        return resetBrowserTimezoneCmd;
    }
    ...
    public CommandResponse execute(CommandParam param) throws CommandException, HttpTimeoutException {
        try {
            ...
            DriverManager.getInstance().resetBrowserTimezone();

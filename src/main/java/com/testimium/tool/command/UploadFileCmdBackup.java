 ...
 */
public class UploadFileCmdBackup implements ExternalCommand<CommandParam, CommandResponse> {
    private WebDriver driver;
    private static UploadFileCmdBackup uploadFileCmd = new UploadFileCmdBackup();

    public UploadFileCmdBackup() {
        this.driver = DriverManager.getInstance().getWebDriver();
    }

    public static UploadFileCmdBackup getInstance() {

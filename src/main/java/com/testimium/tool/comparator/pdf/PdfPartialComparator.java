...
public class PdfPartialComparator extends IToolComparator<String, String, ComparatorResponse> {
    ...
    public ComparatorResponse compare(String actualFilePath, String expectedFilePath, String assertkey) throws ToolComparatorException {
        ...
        pdfutil.setAssertKey(assertkey);
        ...
        try {
            ...
            IToolComparator comparatorTool = ComparatorType.valueOf(ComparatorType.class,"TEXT_PARTIAL_COMPARATOR").getInstance();
            comparatorTool.setOutputFileName("PdfPartialDiff");
            pdfutil.setComparatorTool((TextPartialComparator) comparatorTool);
            ...
            if(StringUtils.isNotEmpty(assertkey) && null != assertParam && null != assertParam.getAssertParams()) {
                ...
                this.assertions.setExcludePattern(mergeDateExcludePattern(this.assertions.getExcludePattern(), this.assertions.getExcludeDatePattern()));
                pdfutil.excludeText(this.assertions.getExcludePattern());
                ...
                //response = getComparatorResponse(actualFilePath, expectedFilePath);
                //TODO throw proper exception for partial compariosion if assertion is not provided
            }

        } catch (Exception ex) {
            ex.printStackTrace();
            throw new ToolComparatorException("PDF Partial Comparison Failed Exception: " + ex.getMessage(), ex);
        }
        return response;
    }
    ...
    private ComparatorResponse getComparatorResponse(String actualFilePath, String expectedFilePath) throws IOException {
        ...
        //pdfutil.setExcludeDatePattern(assertions.getExcludeDatePattern());
        ...
        /*response = new ComparatorResponse((result)? "PASS" : "FAIL",
                ...
                (!result) ? Arrays.asList(this.assertions.getExcludePattern()) : "");*/
        return pdfutil.getComparatorResponse();
    }
}

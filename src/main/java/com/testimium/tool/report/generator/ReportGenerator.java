...
public class ReportGenerator {
    ...
    private String screenshotDir = PropertyUtility.getScreenshotLocation();
    ...
    public static ReportGenerator startNewReport(){
        reportGenerator = new ReportGenerator();
        return reportGenerator;
    }
    public ReportGenerator startNewReport(String batchName){
        if(!batchName.equals(this.batchName)) {
    ...
    public static ReportGenerator getReportInstance(){
    ...
    public void regenerateReport(boolean isBatchComplete) {
        try {
            if(null != reportGenerator && null != reportGenerator.batchData) {
    ...
    private void refreshTestsuiteToReport() {
        if(null != reportGenerator.testSuiteDataList) {
            ...
            } else if (null != reportGenerator.testSuiteData && testSuiteData.getBatchName().equals(this.batchName)) {
                reportGenerator.testSuiteDataList.add(reportGenerator.testSuiteData);
            }
        }
    }
    ...
    public void startNewTestsuite(String testsuiteName){
        ...
        testSuiteData.setBatchName(this.batchName);
    ...
    private int getPreviousReportCount() {
        File inputSrc = new File(reportDir);
